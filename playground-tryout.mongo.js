...
// CRUD operation to Update
db.collection.updateOne(
  { name: 'The Snow Adventurer' },
  { $set: { price: 597 } },
);

// BEST PRACTICE to test Query Object before altering any Documents in DB
db.tours.find({
  price: {
    $gt: 500,
  },
...
// find query with Projection Filter for readability
db.tours.find(
  {
    price: {
      $gt: 500,
